...
with gr.Blocks(title=TITLE, theme=gr.themes.Soft()) as demo:
    ...
    with gr.Tabs():
        with gr.Tab("Văn bản"):
            ...
            inspect_btn.click(inspect_text_ui, [text_in, consent], [text_report])
            clean_btn.click(clean_text_ui, [text_in, consent], [text_out, text_report])
        ...
        with gr.Tab("File"):
            ...
            file_btn.click(clean_file_ui, [file_in, consent], [file_out, file_report])
...
if __name__ == "__main__":
    demo.queue(default_concurrency_limit=2).launch(server_name="0.0.0.0", server_port=int(os.environ.get("PORT", "80")))
